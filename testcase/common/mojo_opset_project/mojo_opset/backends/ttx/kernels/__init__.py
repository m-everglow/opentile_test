...
dllm_attention_fwd_impl = getattr(ttx_backend_module, "dllm_attention_fwd_impl")
dllm_attention_bwd_impl = getattr(ttx_backend_module, "dllm_attention_bwd_impl")
dllm_attention_up_fwd_impl = getattr(ttx_backend_module, "dllm_attention_up_fwd_impl")
dllm_attention_up_bwd_impl = getattr(ttx_backend_module, "dllm_attention_up_bwd_impl")
...
if os.getenv("MOJO_RUN_MODE", "EAGER") == "COMPILE":
    ...
    dllm_attention_fwd = dllm_attention_fwd_impl
    dllm_attention_bwd = dllm_attention_bwd_impl
    dllm_attention_up_fwd = dllm_attention_up_fwd_impl
    dllm_attention_up_bwd = dllm_attention_up_bwd_impl

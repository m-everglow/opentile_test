...
def get_case(num):
    ...
    if num not in cases:
        raise ValueError(f"num should be in [1, 2, 3, 4, 5, 6], but got {num}")
...
if __name__ == "__main__":
    ...
    q_seq_list = cfg["q_seq_list"]
    k_seq_list = cfg["k_seq_list"]
    ...
    root_dir = f"/home/l00567229/ZJ_poc/new/dump1_case{num}"

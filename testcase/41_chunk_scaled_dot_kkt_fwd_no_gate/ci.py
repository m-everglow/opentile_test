...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(1, 31, 1, 1, 32, 16, False, None, id='dense-no-gate-single-bh'),
        pytest.param(1, 32, 1, 1, 32, 16, False, None, id='dense-no-gate-single-bh-no-tail'),
        pytest.param(2, 31, 2, 2, 32, 16, False, None, id='dense-no-gate'),
        #pytest.param(1, 48, 4, 4, 64, 16, False, [0, 15, 48], id='varlen-no-gate'),
    ],
)
